// Languages. The server picks one per request (?lang= → the kb_lang cookie → Accept-Language, see server/i18n.mjs),
// translates the static HTML, and hands this bundle the same dictionary as window.__I18N__ = { lang, dict } from a
// cacheable /i18n/<lang>.js — so the page and the scripts always agree and nothing flashes in English first. English
// is bundled and is the fallback for any key a language lacks.
...
/** Locale for dates: English keeps "25 Sept 2026, 14:10 GMT+8". */
...
export function setLang(lang: string) {
  ...
  document.cookie = `kb_lang=${lang}; path=/; max-age=31536000; samesite=lax`;
